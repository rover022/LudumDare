...
class Play extends Phaser.State {
    private cash: number;
    private chunkGroup: Phaser.Group;
    private nextChunkY: number;
    private lastChunkIndex: number;
    private tephra: Phaser.Group;
    private rocks: Phaser.Group;
    private gems: Phaser.Group;
    private carrots: Phaser.Group;
    private lastChunk: any;
    private chunkIndex: number;
    private dirtEmitter: Phaser.Particles.Arcade.Emitter;
    private drilldirt: Phaser.Sprite;
    private tunnel: Phaser.Particles.Arcade.Emitter;
    private tunnelborder: Phaser.Particles.Arcade.Emitter;
    private deathfade: Phaser.BitmapData;
    private deathfadesprite: Phaser.Sprite;
    private circle: Phaser.Sprite;
    private bunny: Bunny;
    private getEmitter: Phaser.Particles.Arcade.Emitter;
    private fade: Phaser.BitmapData;
    private fadesprite: Phaser.Sprite;
    private dead: boolean;
    private beeping: boolean;
    private sfx: Phaser.Sound;
    private heatgauge: Gauge;
    private powergauge: Gauge;
    private depthtext: Phaser.Text;
    private cashtext: Phaser.Text;
    private gameover: Phaser.Text;
    private depthyo: Phaser.Text;
    private cashyo: Phaser.Text;
    private pressspace: Phaser.Text;
    private dfx: Phaser.Sound;
    ...
    generateChunk() {
        let newChunk = this.chunkGroup.add(this.game.add.group());
        newChunk.y = this.nextChunkY;

        let xPos: number = 0;
        let yPos: number = 0;
        let aboveFace: number = 0;
        let leftFace: number = 0;
        let i: number = 0;
        for (i = 0; i < 5 * 8; i++) {
            if (i !== 0 && i % 5 !== 0) {
